...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center rounded-xl bg-hb-sage/30 p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
